...
def main():
    ...
    link_img = "assets/UN_vote.png" #"https://www.economist.com/sites/default/files/images/print-edition/20220305_FBM981.png"
    ...
    link_idps = "https://data.humdata.org/dataset/697c4fb9-1b76-4a66-808a-9a8fb5ffff1a/resource/013ffdf6-1b14-4a25-a194-4acf82251c75/download/idp_estimation_08_03_2022-unhcr-protection-cluster_.xlsx"
    ...
    link_cbr_forecasts = "assets/full_032022.xlsx" #"http://www.cbr.ru/Collection/Collection/File/40867/full_032022.xlsx"
    ...
    def get_cbr_forecasts(link):
        ...
        """
        df = pd.read_excel(link, skiprows=4, usecols='C:J')
    ...
    def get_casualties(link):
        ...
        num_columns = ['Date', 'Civilian casualities(OHCHR) - Killed', 'Civilian casualities(OHCHR) - Injured', 'Refugees(UNHCR)', 'Attacks on Education Facilities', 'Attacks on Health Care']
        df = df[num_columns]
    ...
    cfig21.plotly_chart(ffx)
    cfig22.plotly_chart(fkrt)
