...
components.iframe("https://datawrapper.dwcdn.net/MicOM/2/", height=600, scrolling=True)
components.iframe("https://datawrapper.dwcdn.net/ZVnMA/4/", height=600, scrolling=True)
components.iframe("https://datawrapper.dwcdn.net/17yDJ/2/", height=600, scrolling=True)
components.iframe("https://datawrapper.dwcdn.net/EQ9IF/3/", height=600, scrolling=True)
